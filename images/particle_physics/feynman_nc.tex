...
\feynmandiagram[
    ...
    e2 [particle = \( \APnu_{\Pe} \)] -- [fermion] v1 [dot] -- [fermion] e3 [particle = \( \APnu_{\Pe} \)],
    e1 [particle = \( \Pelectron \)] -- [fermion]  v2 [dot] -- [fermion] e4 [particle = \( \Pelectron \)],
    v1 -- [boson, edge label = \( \PZzero \)] v2,
};
