...
The brilliance of dilated convolutions lies in the fact that it enables the receptive field to grow exponentially in size, while the parameters only grow linearly.
