...
\begin{table}
    ...
    \begin{tabular}{@{}lll@{}} \toprule
        ...
        \verb|pmt_area| & The surface area of the PMT that recorded the light pulse & \verb|float| \\
        \verb|pmt_type| & Type of PMT (IceCube, mDOM, D-Egg) & \verb|int| \\ \midrule
        \verb|lc| & Local coincidence trigger & \verb|bool| \\
...
\begin{table}
    ...
    Each entry represents an MC generated particle.}\label{tab:truth}
    \begin{tabular}{@{}lll@{}} \toprule
        Name & Description & Type \\ \midrule
