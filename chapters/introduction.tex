...
For that, we need an understanding of the particle physics and machine learning techniques involved, which is explored in~\vref{chap:particle_physics,chap:machine_learning}, respectively.
...
This is not the case, as IceCube's data structure is not well suited for a machine learning task, and thus~\vref{chap:data} goes into both the design of the databases used for the datasets and the selection and features of the data itself.

\Vref{chap:design} goes into the design of the algorithm, including such details as loss functions and optimizers, while~\vref{chap:results} shows results and comparisons to existing methods.

Lastly, a summary and outlook is given in~\vref{chap:summary_and_outlook}.
