...
This reconstruction has a median angular resolution (the arc-distance between reconstruction and the true track) on Monte Carlo data of \( \theta_{\text{med}} = \SI{4.211}{\degree} \)~\autocite{Aartsen2014}.
