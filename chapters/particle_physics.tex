...
\begin{equation}\label{eq:neutrino_wavefunction_2}
	\ket{\psi(L, T)} = \eu^{-\iu \phi_{1}} \left[ \left( \eu^{\iu \Delta{\phi_{1 2}}} - 1 \right) \cos{\theta} \sin{\theta} \ket{\Pnu_{\Pe}} - \left( \eu^{\iu \Delta{\phi_{1 2}}} \cos^{2}{\theta} + \sin^{2}{\theta} \right) \ket{\Pnu_{\Pmu}} \right],
\end{equation}
...
\begin{equation}\label{eq:neutrino_osc_inner_product_1}
	P(\Pnu_{\Pmu} \rightarrow \Pnu_{\Pe}) = \lvert \braket{\Pnu_{\Pe} | \psi(L, T)} \rvert^2 = c_{\Pmu} c_{\Pmu}^{*}.
\end{equation}
...
\begin{equation}\label{eq:survival_probability_1}
	P(\Pnu_{\Pmu} \rightarrow \Pnu_{\Pmu}) = 1 - P(\Pnu_{\Pmu} \rightarrow \Pnu_{\Pe}),
\end{equation}
...
\begin{equation}
	...
	\end{bmatrix}
	\begin{bmatrix}
		c_{1 3} & 0 & s_{1 3} \eu^{-\iu \delta} \\
		0 & 1 & 0 \\
		-s_{1 3} \eu^{\iu \delta} & 0 & c_{1 3}
	\end{bmatrix}
	\begin{bmatrix}
		c_{1 2} & s_{1 2} & 0 \\
		-s_{1 2} & c_{1 2} & 0 \\
...
\begin{equation}\label{eq:survival_probability_2}
	P(\Pnu_{\Pe} \rightarrow \Pnu_{\Pe}) = 1 - 4 \lvert U_{\Pe 1} \rvert^2 \lvert U_{\Pe 2} \rvert^2 \sin^{2}{\Delta_{2 1}} - 4 \lvert U_{\Pe 1} \rvert^2 \lvert U_{\Pe 3} \rvert^2 \sin^{2}{\Delta_{3 1}} - 4 \lvert U_{\Pe 2} \rvert^2 \lvert U_{\Pe 3} \rvert^2 \sin^{2}{\Delta_{3 2}}
\end{equation}
